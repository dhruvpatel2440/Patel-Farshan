...
import { ADMIN_COOKIE, adminCookieOptions, createAdminToken } from '@/lib/adminSession'

/**
 * Admin login, step 2: check the emailed code and mint the elevation cookie
 * that /admin actually requires.
 */
